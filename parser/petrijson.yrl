...
place -> identifier integer integer integer: {struct, [{type, place}, {name, value_of('$1')}, {x, value_of('$2')}, {y, value_of('$3')}, {markers, value_of('$4')}]}.
...
transition -> identifier integer integer integer float: {struct, [{type, transition}, {name, value_of('$1')}, {x, value_of('$2')}, {y, value_of('$3')}, {w, value_of('$4')}, {delay, value_of('$5')}]}.

arcs_block -> arcs_tok arcs end_tok arcs_tok: '$2'.
arcs_block -> arcs_tok end_tok arcs_tok.
arcs -> arc: ['$1'].
arcs -> arc arcs: ['$1' | '$2'].
arc -> identifier identifier identifier: {struct, [{type, arc}, {name, value_of('$1')}, {from, value_of('$2')}, {to, value_of('$3')}]}.
